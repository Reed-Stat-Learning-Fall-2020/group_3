...
```{r partyid-dist, echo = FALSE, warning = FALSE, message = FALSE}
#Party-wise counts 
...
Now, we fit the logistic-regression model with weights using the svyglm() function to our training set. 
```{r, warning = FALSE, message = FALSE}
 options(survey.lonely.psu="certainty")
...
Now, we see how our model performs on the test set and calculate the test error rate. 
