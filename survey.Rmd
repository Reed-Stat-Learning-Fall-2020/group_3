...
Now, we fit the logistic-regression model with the svyglm() function from the survey package.6 A
slight wrinkle is that we must use the quasibinomial rather than the binomial family to avoid a
warning about noninteger counts produced by the use of differential sampling weights. 
